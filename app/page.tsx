        ...
        <section className="py-20 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              ...
              >
                ...
                <div className="relative p-8 rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-xl hover:border-white/20 transition-all">
                  <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center mb-4">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/20 via-blue-500/20 to-cyan-500/20 rounded-3xl blur-2xl" />
              ...
              {[
                {
                  ...
                  desc: "Procesamiento de primitivas completas con capacidad de emisión múltiple",
                },
                {
                  title: "Generación Dinámica",
                  desc: "Creación de nueva geometría sin intervención de la CPU",
                },
                {
                  title: "Pipeline Programable",
                  desc: "Control total sobre la transformación y generación de vértices",
                },
                {
                  title: "Rendering Procedural",
                  desc: "Efectos visuales complejos generados algorítmicamente",
                },
              ].map((item, i) => (
                <motion.div
                  key={i}
